...
const int sbiCycles = 2;  //2
const int cbiCycles = 2;  //2
...
#define WS2812B_1H_CY CYCLES(450)//(650)  // 650ns-950ns _----------__
#define WS2812B_1L_CY CYCLES(450)//(125)  // 250ns-550ns .    .    .
#define WS2812B_0H_CY CYCLES(150)//(125)  // 250ns-550ns _-----_______
#define WS2812B_0L_CY CYCLES(750)//(650)  // 650ns-950ns .    .    .
#define WS2812B_MS_REFRESH 90  //50      // 50,000ns Minimum sleep time to reset LED strip
...
////////////////////////////////////////////////////////////////////////////////
#define WS2812_1H_CY CYCLES(450)  // 500ns 550ns-850ns  _----------__
#define WS2812_1L_CY CYCLES(450)  // 125ns 200ns-500ns  .    .    .
#define WS2812_0H_CY CYCLES(150)  // 125ns 200ns-500ns  _-----_______
#define WS2812_0L_CY CYCLES(750)  // 500ns 550ns-850ns  .    .    .
#define WS2812_MS_REFRESH 150      //  50,000ns Minimum wait time to reset LED strip
#define WS2812_NS_RF 2000000      // Max refresh rate for all pixels to light up 2msec (LED PWM is 500Hz)
...
#define APA104_MS_REFRESH 80//50      //  50,000ns Minimum wait time to reset LED strip
